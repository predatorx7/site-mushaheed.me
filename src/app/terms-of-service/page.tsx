    ...
    <>
      <section>
        ...
        <div className="prose prose-neutral dark:prose-invert">
          <p>Welcome to Mushaheed's Personal Website!</p>

          <p>
            These terms of service outline the rules and regulations for the use
            of my Website, located at https://mushaheed.me.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Mushaheed's Personal Website if
            you do not agree to take all of the terms of service stated on this
            page.
          </p>
          ...
          <p>
            We employ the use of cookies. By accessing Mushaheed's Personal
            Website, you agreed to use cookies in agreement with the
            https://mushaheed.me's Privacy Policy.{" "}
          </p>

          <p>
            Most interactive websites use cookies to let us retrieve the user's
            details for each visit. Cookies are only used by our website to
            enable the functionality of certain areas like authentication to
          ...
          <p>
            Unless otherwise stated, https://mushaheed.me and/or its licensors
            own the intellectual property rights for all material on Mushaheed's
            Personal Website. All intellectual property rights are reserved. You
            may access this from Mushaheed's Personal Website for your own
          ...
          <p>You must not:</p>
          <ul>
            <li>Republish material from Mushaheed's Personal Website</li>
            <li>
              Sell, rent or sub-license material from Mushaheed's Personal
              Website
            </li>
            <li>
              Reproduce, duplicate or copy material from Mushaheed's Personal
              Website
            </li>
            <li>Redistribute content from Mushaheed's Personal Website</li>
          </ul>
          ...
          <p>
            ...
            https://mushaheed.me does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of https://mushaheed.me, its agents
            ...
            applicable laws, https://mushaheed.me shall not be liable for the
          ...
          <p>
            https://mushaheed.me reserves the right to monitor all Comments and
            to remove any Comments which can be considered inappropriate,
            offensive or causes breach of these terms of service.
          </p>
          ...
          <p>
            You hereby grant https://mushaheed.me a non-exclusive license to
          ...
          <p>
            ...
            https://mushaheed.me; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to https://mushaheed.me. Please include your name,
          ...
          <p>
            No use of https://mushaheed.me's logo or other artwork will be
          ...
          <p>
            ...
            amen these terms of service and it's linking policy at any time. By
