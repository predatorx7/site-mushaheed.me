    ...
    <>
      <section>
        ...
        <div className="prose prose-neutral dark:prose-invert">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Mushaheed's
                Website.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Mushaheed's Website,
                accessible from{" "}
                <a
                  href="https://mushaheed.me"
          ...
          <ul>
            <li>By email: hello@mushaheed.me</li>
          </ul>
        </div>
      </section>
    </>
